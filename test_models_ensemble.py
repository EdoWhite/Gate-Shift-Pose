...
if args.input_size == 0:
    input_size_rgb = net_rgb_list[0].input_size
    scale_size_rgb = net_rgb_list[0].scale_size
else:
...
# DEPTH
if args.input_size == 0:
    input_size_depth = net_depth_list[0].input_size
    scale_size_depth = net_depth_list[0].scale_size
else:
...
if args.test_crops == 1:
    ...
    cropping_rgb = torchvision.transforms.Compose([
        GroupFullResSample(input_size_rgb, net_rgb_list[0].scale_size, flip=False)
    ])
...
if args.test_crops == 1:
    ...
    cropping_depth = torchvision.transforms.Compose([
        GroupFullResSample(input_size_depth, net_depth_list[0].scale_size, flip=False)
    ])
elif args.test_crops == 5:
    cropping_depth = torchvision.transforms.Compose([
...
data_loader_rgb = torch.utils.data.DataLoader(
        VideoDataset(
            ...
            transform=torchvision.transforms.Compose([
                ...
                ToTorchFormatTensor(),
                GroupNormalize(net_rgb_list[0].input_mean, net_rgb_list[0].input_std,
...
data_loader_depth = torch.utils.data.DataLoader(
        VideoDataset(
            ...
            transform=torchvision.transforms.Compose([
                ...
                Stack(roll=(args.arch in ['bninception', 'inceptionv3'])),
                ToTorchFormatTensor(),
                GroupNormalize(net_depth_list[0].input_mean, net_depth_list[0].input_std,
                                div=(args.arch not in ['bninception', 'inceptionv3']))
            ]),
            num_clips=args.num_clips,
            mode="val"
